...
import 'detail_riwayat_seminar.dart';

class RiwayatSeminar extends StatefulWidget {
  const RiwayatSeminar({super.key});

  @override
  State<RiwayatSeminar> createState() => _RiwayatSeminarState();
}

class _RiwayatSeminarState extends State<RiwayatSeminar> {
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: Obx(() {
          if (riwayatController.isLoading.value) {
          ...
          } else if (riwayatController.riwayatSemproList.isEmpty) {
            return Padding(
            ...
            RxList listRiwayat = riwayatController.riwayatSemproList;
            listRiwayat.sort((a, b) => b.createdAt.compareTo(a.createdAt));

            return RefreshWidget(
              keyRefresh: keyRefresh,
              onRefresh: riwayatController.getRiwayatSempro,
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            listRiwayat.ruangSempro.isEmpty
                                                ? "-"
                                                : listRiwayat.ruangSempro,
                                            style: const TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: SimtaColor.birubar,
                                            ),
